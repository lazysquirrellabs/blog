...
---
In this article, we will walk through the process of generating icospheres (spheres based on a regular icosahedron) with code. I started looking into icospheres when working on Terraced Terrain Generator (TTG) 2.0 ([GitHub](https://github.com/lazysquirrellabs/TTG), [OpenUPM](https://openupm.com/packages/com.lazysquirrellabs.terracedterraingenerator)), which added support for spherical terrains. I dedicated some time to study different sphere types and ended up creating a small library to procedurally generate spheres (*ico-*, *cube-* and UV-spheres) in Unity: Sphere Generator ([GitHub](https://github.com/lazysquirrellabs/sphere_generator), [Unity Asset Store](https://assetstore.unity.com/packages/tools/modeling/spheres-generator-311994), [OpenUPM](https://openupm.com/packages/com.lazysquirrellabs.spheregenerator/)). Building the library inspired me to write this piece.
...
The techniques described here were used to add spherical terrain support to Terraced Terrain Generator (TTG) 2.0 ([GitHub](https://github.com/lazysquirrellabs/TTG), [OpenUPM](https://openupm.com/packages/com.lazysquirrellabs.terracedterraingenerator)) and Sphere Generator's ([GitHub](https://github.com/lazysquirrellabs/sphere_generator), [Unity Asset Store](https://assetstore.unity.com/packages/tools/modeling/spheres-generator-311994), [OpenUPM](https://openupm.com/packages/com.lazysquirrellabs.spheregenerator/)) icosphere support.
