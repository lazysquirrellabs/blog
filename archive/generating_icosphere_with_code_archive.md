...
---
> ⛔️ This page is an outdated version of a post that has been modified after its original publication. This version describes icosphere generation strategies that were further improved and it's maintained for reference purposes only. You should read [the revised post](/posts/generating_icosphere_with_code) instead.
